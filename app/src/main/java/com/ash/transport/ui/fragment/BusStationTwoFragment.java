 ...
 * @date:      on 2019-05-27 22:03
 * @继承关系:   BusStationTwoFragment ← BaseFragment ← [Fragment]
 *----------------------------------------------*/
public class BusStationTwoFragment extends BaseFragment {
    ...
    protected int setLayoutId() {
        return R.layout.fragment_bus_station_2;
    }
    ...
    private void queryBusStation() {
        ...
        getBusStationRequest.setStationId(2);   // 查询 2号站台 信息
